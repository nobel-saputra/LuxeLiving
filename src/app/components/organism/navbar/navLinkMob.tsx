  ...
  return (
    <div className="md:hidden mt-4 pb-2">
      <div className="flex flex-col space-y-3">
        <Link href="/" className="hover:text-gray-500 poppins-regular py-1">
          Home
        </Link>
        <Link href="/about" className="hover:text-gray-500 poppins-regular py-1">
          Properties
        </Link>
        <Link href="/contact" className="hover:text-gray-500 poppins-regular py-1">
          About Us
        </Link>
        <Link href="/contact" className="hover:text-gray-500 poppins-regular py-1">
          Contact Us
