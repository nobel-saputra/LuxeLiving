    ...
    <>
      <div className={`${poppins}`}>
        <div className="mt-16 max-w-sm rounded-xl overflow-hidden shadow-2xl bg-[#f8f4e1]">
          {/* Card Image */}
          <Image className="w-full" src="/images/properties/card-6.png" alt="Sunset in the mountains" width={400} height={300} />
          <div className="px-6 py-4">
            {/* Text Card */}
            <p className="font-medium text-xl ms-1 mb-4">Forest House</p>
