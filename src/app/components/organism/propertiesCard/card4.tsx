  ...
  return (
    <>
      <div className={`${poppins}`}>
        <div className="xl:mt-16 md:mt-0 lg:mt-16 max-w-sm rounded-xl overflow-hidden shadow-2xl bg-[#f8f4e1]">
          {/* Card Image */}
          <Image className="w-full" src="/images/properties/card-4.png" alt="Sunset in the mountains" width={400} height={300} />
          <div className="px-6 py-4">
            {/* Text Card */}
            <p className="font-medium text-xl ms-1 mb-4">The House</p>
            <div className="flex flex-col gap-3 text-sm">
              ...
              <div className="flex items-center gap-1">
                <CircleDollarSign />
                <p className="font-medium">Rp 8.200.000.000</p>
              </div>
              <hr />
              {/* ruler & bed */}
              <div className="flex items-center gap-1">
                <Ruler className="w-[20px] h-[20px]" />
                <p className="font-medium me-2">470 m²</p>
                {/* pembeda */}
