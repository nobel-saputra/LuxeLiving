  ...
  return (
    <>
      <div className={`${poppins}`}>
        <div className="mt-16 max-w-sm rounded-xl overflow-hidden shadow-2xl bg-[#f8f4e1]">
          {/* Card Image */}
          <Image className="w-full" src="/images/properties/card-5.png" alt="Sunset in the mountains" width={400} height={300} />
          <div className="px-6 py-4">
            {/* Text Card */}
            <p className="font-medium text-xl ms-1 mb-4">Good House</p>
            <div className="flex flex-col gap-3 text-sm">
              <div className="flex items-center gap-1">
                <Locate />
                <p className="font-medium">Sulawesi Tenggara, Indonesia</p>
              </div>
              <div className="flex items-center gap-1">
                <CircleDollarSign />
              ...
              <div className="flex items-center gap-1">
                ...
                <p className="font-medium me-2">500 m²</p>
                {/* pembeda */}
                <BedDouble className="w-[20px] h-[20px]" />
                <p className="font-medium">2 Beds</p>
              </div>
              {/* ruler & bed (end) */}
              ...
              <div className="flex item-center gap-1">
                ...
                <p className="font-medium me-3">1 Bath</p>
                {/* pembeda */}
